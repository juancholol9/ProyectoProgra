    ...
    <div class="modal-content">
      ...
      <form role="form"  id="formulario" name="formulario">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" placeholder="Ingrese nombre del trabajador" name="trabajador" id="trabajador" required>
                <input type="text" hidden name="idtrabajador" id="idtrabajador">
              </div>
...
<script type="text/javascript" src="scripts/trabajadores.js"></script>
