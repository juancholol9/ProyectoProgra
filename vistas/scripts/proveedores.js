...
function init(){
	...
	listar();
	$.post("../ajax/proveedores.php?opc=listapr", function(r){
		$("#lugares").html(r);
...
$.post("../ajax/proveedores.php?opc=mostrar",{idcategoria : idcategoria}, function(data, status)
	{
...
//	e.preventDefault(); //No se activará la acción predeterminada del evento	
	...
	$.ajax({
		url: "../ajax/proveedores.php?opc=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function listar(){
	...
	tabla=$('#tbllistado').dataTable(
    {
		...
		"ajax":
				{
					url: '../ajax/proveedores.php?opc=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
